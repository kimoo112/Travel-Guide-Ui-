            ...
            children: [
              ...
              homePageCardsGroup(
                ...
                DetailsScreen(
                  ...
                  text: "The Egyptian Museum is one of the largest and most famous international museums, located in the heart of the Egyptian capital, Cairo, on the northern side of Tahrir Square. Its establishment dates back to the year 1835 and its location at that time was in Azbekiya Park, where at that time it included a large number of various antiquities.",
                  image: "assets/images/cairo1.jpg",
                  place1: "Khan Al-Khalily",
                  text1: "Khan El Khalili is one of the neighborhoods of Old Cairo. It enjoys a great tourist attraction for visitors to Cairo and Egypt in general. It is characterized by the presence of popular bazaars, shops and restaurants. It is also characterized by the large number of tourists and the familiarity of its residents with them.",
                  image1: "assets/images/cairo2.jpg",
                  place2: "Salah al-den al-ayobi's castle ",
                  text2: "The Citadel of Salah al-Din al-Ayyubi in Cairo is considered one of the most luxurious military castles that were built in the Middle Ages. The castle and the city are in a state of siege, and it will become the last stronghold to sit in in the event that the city falls into the hands of the enemy.",
              ...
              homePageCardsGroup(
                  Color(0xff63ace5),
                  "assets/images/borsaied.jpg",
                  'Port Said',
                  context,
                  DetailsScreen(
                    title: 'Port Said',
                     place: " Port Said Military Museum",
                    text: "The Port Said Military Museum is one of the museums in the city of Port Said. The Port Said Museum was established in 1964 to commemorate the 1956 tripartite aggression against the city of Port Said, in order to be a witness throughout history to the valiant heroism of the people of Port Said in defending the land.[1] The museum was established on an area of approximately 7,000 square meters in its current location on July 23 Street, in front of Mubarak Military Hospital, in 1964.",
                    image: "assets/images/PortSaid1.jpg",
                    place1: " Ferial Garden",
                    text1: "Ferial Park is located in Port Said, Egypt. It was named after Princess Ferial, daughter of King Farouk.[1] The park is a tourist attraction in the city. The park includes green spaces, flowers, plants and trees in aesthetic shapes, a red mill that serves as a center for surveillance cameras, as well as a wooden bridge and a number of murals that tell excerpts from the history of Port Said, in addition to a theatre, an Andalusian-style mosque, and private seating areas for adults. Age, decorative columns",
                    image1: "assets/images/PortSaid2.jpg",
                    place2: "	Salt Mountains",
                    text2: "The Salt Mountains in the city of Port Fouad are a large group of mountains, characterized by their bright white color, and take large areas similar to the snow mountains in the Arctic",
              ...
              homePageCardsGroup(
                  Color(0xffFF6D6D),
                  "assets/images/herghada.jpg",
                  'Marsa Matrouh',
                  context,
                  DetailsScreen(
                    title: 'Marsa Matrouh',
                    place: " Agiba Beach  ",
                    text: "This beach is located in front of a giant rock, under which people walk, enjoying this wonderful scene that is distinguished among the beaches of the world. water.",
                    image: "assets/images/Marsa Matrouh1.jpg",
                    place1: " Rommel Museum ",
                    text1: "The museum is a cave that Nazi leader Erwin Rommel took as his headquarters during the Nazis' plan to control Egypt and the Suez Canal.",
                    image1: "assets/images/Marsa Matrouh2.jpg",
                    place2: " El Alamein Military Museum  ",
                    text2: "The El Alamein Military Museum is a museum that commemorates the decisive battles of El Alamein that took place during World War II on and around the Egyptian land of El Alamein.",
                  ...
                  Colors.lightGreen,
                  "assets/images/ismalia.jpg",
                  'Ismailia',
                  DetailsScreen(
                    title: 'Ismailia',
                    place: " Crocodile Lake",
                    text: "Lake Timsah is one of four salt water lakes that pass through the Suez Canal in northeastern Egypt (the lakes, in order from north to south, are: Lake Manzala, Lake Timsah, Greater Bitter Lake and Lesser Bitter Lake. Most of the lake is shallow, with a depth of no more than one meter, and an area of about 14 km2",
                    image: "assets/images/Ismailia1.jpg",
                    place1: "	Al-Fardan Bridge",
                    text1: "Al-Fardan Bridge is a movable railway bridge that passes over the Suez Canal near Ismailia in Egypt. It is the longest movable bridge in the world, with a length of 340 meters.",
                    image1: "assets/images/Ismaila2.jpg",
                    place2: " Ismailia Antiquities Museum",
                    text2: "The Ismailia Antiquities Museum is a museum in Ismailia, Egypt. The museum was built by the engineers working for the International Maritime Navigation Company (currently the Suez Canal Authority) in 1911. The museum was opened for visitors in 1913. The museum includes a collection of artifacts from the different eras of Egypt’s history, beginning with the Pharaonic era until the era of the governor, Muhammad Ali.",
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: Color.fromARGB(255, 2, 1, 17).withOpacity(.3),
                  spreadRadius: 3,
                  blurRadius: 7,
                  offset: Offset(5, 3),
                ),
            ...
            child: Column(
              ...
              children: [
                SizedBox(),
                Container(
                    height: _w / 4, width: _w / 4, child: Image.asset(image)),
                Text(
                  title,
                  maxLines: 4,
                  softWrap: true,
